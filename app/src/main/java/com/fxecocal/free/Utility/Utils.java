...
public class Utils {
    ...
    public static void showOKDialog(Context context, String message){
        ...
        builder.setTitle(Const.INDECATOR);
...
//        dialog.setCanceledOnTouchOutside(false);
    ...
    public static SharedPreferences getSharedPreferences(Context context) {
        ...
        try {
            objSharedPreferences = context.getSharedPreferences(
                    Const.INDECATOR, Context.MODE_PRIVATE);
    ...
    public static void saveArrayToPreference(Context context, String key, Set<String> set){
        SharedPreferences preferences = getSharedPreferences(context);
        /////////save user information in preference
        SharedPreferences.Editor edit = preferences.edit();
    ...
    public static Set<String> getArrayFromPreference(Context context, String key) {
